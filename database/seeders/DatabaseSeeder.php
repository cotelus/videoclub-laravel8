...
class DatabaseSeeder extends Seeder{
    /**
     * This array is provisional. Eventually will be in database storage
     */
    ...
    /**
     * Initialice database table "movies" with $movies array data
     * 
     * @return void
     */
    private function seedCatalog(){
        ...
        foreach( $this->movies as $pelicula ) {
            $p = new Movie;
